...
insert into products (name,price,coffee_origin) values ('cothas',2,'India');

select * from products;

insert into products (name,price,coffee_origin) values ('cap',3.50,'CR'),('latte',3.50,'indonesia'),('americano',3.00,'brazil'),('FW',3.50,'indonesia'),('filter',3.00,'India');

update products 
set coffee_origin = 'SL'
where id = 8;
